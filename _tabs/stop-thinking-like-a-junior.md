...
permalink: /workshops/stop-thinking-like-a-junior/
order: 6
---
...
1. **Junior mindset → senior mindset.** The patterns that get you hired, and why they stop working.
2. **The human factor.** What nobody told you about working with people.
3. **Communication and code reviews.** Reviews as the most underused growth tool in your career.
4. **Does technical knowledge still matter?** (Yes — but not the way you think.)
5. **Thinking in systems, not features.** How seniors see ripple effects and trade-offs.
6. **Managing time and energy.** Why busy is not the same as effective.
7. **From growth to influence.** How to scale your impact beyond your own keyboard.
...
I'm a senior engineer at Spotify and have been writing about software craftsmanship and engineering careers for almost a decade at [sandordargo.com](https://www.sandordargo.com). I'm the author of *The Seniority Trap* and several books on modern C++. I speak regularly at conferences including CppCon, C++ on Sea, Meeting C++, and C++ Online.
