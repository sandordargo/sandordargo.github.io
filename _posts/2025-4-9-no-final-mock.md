...
> `final` is not a keyword, "only" an *"identifier with special meaning"*. Technically, it can be used as a name for objects or functions, but it can have a special meaning if used at the right place. If you want readable code though, don't use it as an identifier!
