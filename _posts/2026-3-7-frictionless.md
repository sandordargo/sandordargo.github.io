---
layout: post
title: "Frictionless by Nicole Forsgren and Abi Noda"
date: 2026-3-7
category: books
tags: [books, devex, craftsmanship]
excerpt_separator: <!--more-->
---
I haven't written a book review for quite a while. [Since I set a yearly goal to start doing it again](), here is my first one: [*Frictionless: 7 Steps to Remove Barriers, Unlock Value, and Outpace Your Competition in the AI Era*](https://amzn.to/3ZFcz86).

The authors are highly relevant contributors to the field they are writing about. Nicole Forsgren was a main author of [*Accelerate*](https://amzn.to/4qJbcRH) and played a key role in creating the [DORA](https://dora.dev/guides/dora-metrics/) and [SPACE](https://getdx.com/blog/space-metrics) productivity frameworks. The other author, Abi Noda, worked on the [DevEx](https://www.infoq.com/articles/devex-metrics-framework/) framework.
...
If these topics interest you, [*Frictionless*](https://amzn.to/3ZFcz86) is a must-read. But to be fair, even if you're an engineer regularly cursing "the business" because you can't sell seemingly small improvements or refactorings — and you're not particularly interested in the broader DevEx picture — it is still worth reading this book. It can help you learn how to translate engineering concerns into business cases.
