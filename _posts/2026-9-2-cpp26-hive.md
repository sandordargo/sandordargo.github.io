...
---
In a [recent article on `std::inplace_vector`](https://www.sandordargo.com/blog/2026/08/26/cpp26-inplace-vector), I mentioned that C++26 is generous with new containers. Here's the other one: `std::hive`.
